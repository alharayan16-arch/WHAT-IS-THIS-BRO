...
async def create_welcome_gif(member):
    ...
    for i in range(total_frames):
        ...
        # Main title
        draw.text((70, 70), f"Welcome {username}", font=font_big, fill=(255, 255, 255, 255))

        # Avatar
        img.paste(avatar, (70, 150), avatar)

        # Info text
        draw.text((140, 155), member_count, font=font_small, fill=(180, 180, 255, 255))
        draw.text((140, 185), join_time, font=font_small, fill=(180, 180, 255, 255))
